...
- (IBAction)tenOfHeartsSwitch:(id)sender {
...
- (IBAction)eightOfDiamondsSwitch:(id)sender {
...
- (IBAction)fourOfClubsSwitch:(id)sender {
...
- (IBAction)threeOfSpadesSwitch:(id)sender {
